...
const rawProjectCatalog = [
  {
    ...
    shortSummary:
      'Main emergency project: complete a durable sanctuary structure for safe worship after storm damage.',
    urgency: 'Urgent',
    objective:
      'Rebuild and complete a permanent sanctuary with heavy-duty steel framing, roofing, seating base, and safety improvements.',
    donationUse: [
      'Steel columns, trusses, and anchoring works',
      'Roofing sheets and weatherproofing sections',
      'Safe interior seating base and worship layout',
      'Perimeter protection and compound security works',
    ],
    expectedImpact:
      'Creates a safe, dignified worship space for 868 members and protects ministry continuity through severe weather seasons.',
    budgetCurrency: 'USD',
    budgetItems: [
      {
        id: 'steel-columns',
        item: 'Steel columns and anchoring foundation pack',
        cost: 3200,
        detail: 'Primary support frame, anchor bolts, and installation consumables.',
      },
      {
        id: 'roofing-sheets',
        item: 'Roofing sheets and weatherproofing set',
        cost: 2800,
        detail: 'High-gauge sheets, ridge caps, sealant layers, and fasteners.',
      },
      {
        id: 'trusses-bracing',
        item: 'Roof trusses and wind bracing kit',
        cost: 1900,
        detail: 'Wind-resistant truss network and anti-sway structural bracing.',
      },
      {
        id: 'seating-base',
        item: 'Interior seating base and floor leveling',
        cost: 2400,
        detail: 'Compacted base preparation and stable worship seating layout zoning.',
      },
      {
        id: 'safety-fencing',
        item: 'Perimeter woven-wire safety fencing',
        cost: 1600,
        detail: 'Compound perimeter security lines and controlled access points.',
      },
      {
        id: 'electrical-lighting',
        item: 'Basic electrical and interior lighting package',
        cost: 1200,
        detail: 'Safe wiring routes, essential fixtures, and evening service lighting.',
      },
      {
        id: 'labor-logistics',
        item: 'Skilled labor and site logistics support',
        cost: 1500,
        detail: 'Welding labor blocks, transport handling, and site coordination costs.',
      },
    ],
    currentMedia: [
      {
