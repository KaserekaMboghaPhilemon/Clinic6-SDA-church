...
const rawProjectCatalog = [
  {
    ...
    donationUse: [
      ...
      "Interior seating base, floor leveling, and basic electrical",
      {
        ...
        cost: 8500,
        detail:
          "Primary vertical frame: full-length structural poles at required spacing for 30 m × 15 m footprint.",
      },
      {
        ...
        cost: 6200,
        detail:
          "Horizontal purlins, cross-bracing bars, and angle-iron ties securing the entire metal skeleton.",
      },
      {
        id: "iron-sheets-roof",
        ...
        cost: 9800,
        detail:
          "Heavy-gauge corrugated iron sheets covering the 30 m × 15 m roof span, ridge caps, and lap sealant.",
      },
      {
        ...
        cost: 7400,
        detail:
          "Perimeter wall cladding on all sides (30 m front/back + 15 m sides × 5 m wall-plate height) with bolt-fixed iron sheets.",
      },
      {
        ...
        cost: 2800,
        detail:
          "All joining, fastening, and sealing consumables for the full metal structure.",
      },
      {
        id: "labor-logistics",
        ...
        cost: 6500,
        detail:
          "Certified welding team, equipment hire, material transport within Kakuma, and site coordination.",
      },
      {
        ...
        cost: 4800,
        detail:
          "Compacted floor base, worship seating layout, essential wiring, and interior lighting.",
      },
    ],
    currentMedia: [
      {
      ...
      {
        type: "image",
        src: "/src/assets/wornout-clinic6-church.png",
    ...
    budgetItems: [
      {
        ...
        cost: 650,
        detail:
          "Child-friendly seating, mats, and flexible worship-circle layout support.",
      },
      {
        id: "child-shade",
        ...
        cost: 900,
        detail:
          "Safe protective cover and simple partitions for children ministry sessions.",
      },
      {
        id: "child-learning",
        ...
        cost: 420,
        detail:
          "Visual teaching tools, lesson cards, stationery, and age-specific discipleship kits.",
      },
      {
        id: "child-storage",
        ...
        cost: 380,
        detail:
          "Cabinets, safe bins, and ministry equipment organization support.",
      },
    ],
    currentMedia: [
      {
    ...
    budgetItems: [
      {
        ...
        cost: 700,
        detail:
          "Staple food support for vulnerable households facing immediate need.",
      },
      {
        id: "care-kits",
      ...
      },
      {
        ...
        cost: 340,
        detail:
          "Transport and community follow-up logistics for urgent support visits.",
      },
      {
        ...
        cost: 260,
        detail:
          "Structured welfare follow-up and church-led relief coordination support.",
      },
    ],
    currentMedia: [
      {
    ...
    budgetItems: [
      {
        ...
        cost: 1400,
        detail:
          "Beds, bedding, protective room setup, and shelter-readiness needs.",
      },
      {
        id: "agape-care",
        ...
        cost: 760,
        detail:
          "Child care supplies, hygiene support, and protection-centered care materials.",
      },
      {
        id: "agape-mentorship",
        ...
        cost: 480,
        detail:
          "Pastoral care tools and structured support for restoration and belonging.",
      },
      {
        id: "agape-learning",
    ...
    budgetItems: [
      {
        ...
        cost: 1100,
        detail:
          "Pit lining, reinforcement, and safe water containment materials.",
      },
      {
        id: "jordan-access",
      ...
      },
      {
        ...
        cost: 760,
        detail:
          "Storage containers, handling tools, and transport support for repeated ministry use.",
      },
      {
        id: "jordan-cover",
        ...
        cost: 390,
        detail:
          "Temporary protection, setup support, and orderly ministry presentation.",
      },
    ],
    currentMedia: [
      {
    ...
    budgetItems: [
      {
        ...
        cost: 1800,
        detail:
          "Heavy-gauge woven-wire rolls sufficient to secure the full compound boundary.",
      },
      {
        id: "fence-posts",
        ...
        cost: 920,
        detail:
          "Galvanised steel posts with concrete anchoring and tensioning fittings for lasting rigidity.",
      },
      {
        id: "fence-gate",
        ...
        cost: 540,
        detail:
          "Heavy-duty entry/exit gate with padlock system and controlled access hardware.",
      },
      {
        id: "fence-labour",
        ...
        cost: 640,
        detail:
          "Skilled fencing labour, site preparation, and waste clearance on completion.",
      },
    ],
    currentMedia: [
      {
