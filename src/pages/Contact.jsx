        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          <article className="rounded-2xl border border-[#0F2942]/15 bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 space-y-4 text-sm">
              <div>
                <p className="font-semibold text-[#0F2942]">{t('contact.channels.emailLabel')}</p>
                <a
              ...
              <div>
                <p className="font-semibold text-[#0F2942]">{t('contact.channels.paybillLabel')}</p>
                <p className="font-mono text-base">247247</p>
              </div>
              <div>
                <p className="font-semibold text-[#0F2942]">{t('contact.channels.accountLabel')}</p>
                <p className="font-mono text-base">1650280005225</p>
              </div>
            </div>
          ...
          <article className="rounded-2xl border border-[#0F2942]/15 bg-white p-6 shadow-sm">
            ...
            <ol className="mt-6 space-y-3 text-sm text-[#2D3142]/90">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-[#0F2942]">SDA Lokichogio District</p>
                  <p className="text-[11px] uppercase tracking-widest text-[#2D3142]/60">{t('footer.tier.localLabel')}</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-2 h-1.5 w-1.5 rounded-full bg-[#D4AF37] shrink-0" />
                <div>
                  ...
                  <p className="text-[11px] uppercase tracking-widest text-[#2D3142]/60">{t('footer.tier.stationLabel')}</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                <span className="mt-2 h-1.5 w-1.5 rounded-full bg-[#D4AF37] shrink-0" />
                <div>
                  <p className="font-semibold text-[#0F2942]">Rift Valley Field</p>
                  <p className="text-[11px] uppercase tracking-widest text-[#2D3142]/60">{t('footer.tier.fieldLabel')}</p>
                </div>
              </li>
            </ol>
          </article>
