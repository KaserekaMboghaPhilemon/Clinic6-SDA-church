...
function MpesaPanel() {
  return (
    <div className="space-y-3">
      ...
      <StaticField label="Account Name"        value="Clinic6 SDA Church" />
      <div className="bg-[#0F2942] text-white rounded-2xl px-5 py-4 mt-4">
        ...
        <ol className="mt-2 text-sm leading-relaxed text-white/90 list-decimal list-inside space-y-1">
          ...
          <li>Enter Business No. <span className="font-bold text-[#D4AF37]">247247</span></li>
          <li>Account No. <span className="font-bold text-[#D4AF37]">1650280005225</span></li>
...
function BankPanel() {
  return (
    <div className="space-y-3">
      <StaticField label="Bank"           value="Equity Bank Kenya" />
      <StaticField label="Branch"         value="Lokichogio Branch" />
      <CopyField   label="Account No."    value="1650280005225" />
      <StaticField label="Account Name"   value="Clinic6 SDA Church" />
      <p className="text-xs text-[#0F2942]/60 leading-relaxed pt-2 px-1">
        Please reference <span className="font-semibold text-[#0F2942]">"SEATS"</span> or
        <span className="font-semibold text-[#0F2942]"> "SANCTUARY"</span> in the
        transaction narrative so we can attribute your gift correctly.
      </p>
    </div>
  )
}
...
function WirePanel() {
  return (
    <div className="space-y-3">
      ...
      <StaticField label="Bank"               value="Equity Bank Kenya Ltd." />
      <StaticField label="Branch"             value="Lokichogio, Turkana County, Kenya" />
      <CopyField   label="Beneficiary Acc."   value="1650280005225" />
      <StaticField label="Beneficiary Name"   value="Clinic6 SDA Church" />
      <p className="text-xs text-[#0F2942]/60 leading-relaxed pt-2 px-1">
        For international remittances. Your sending bank may require an
        intermediary correspondent — please request this from Equity Bank if asked.
      </p>
    </div>
  )
}
...
export default function GivingGateway() {
  ...
  const seatsPercent  = Math.min(100, Math.round((seatsSecured / seatsGoal) * 100))
  ...
  return (
    <section className="relative overflow-hidden bg-[#F7F4EF] text-[#0F2942] py-24 md:py-32 px-6">
      ...
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(#0F2942 1px, transparent 1px)',
            ...
            <div className="mt-8 flex items-start gap-4 border-l-4 border-[#D4AF37] bg-[#D4AF37]/[0.07] rounded-r-2xl px-5 py-4">
              ...
              <div>
                ...
                <p className="text-sm text-[#0F2942] leading-relaxed mt-1">
                  ...
                  <span className="font-semibold"> Freewill Offerings</span> above and
                  beyond Tithe. Tithe is returned through your local conference channels.
                </p>
              </div>
            </div>
            ...
            <div className="mt-8">
              <div className="flex items-end justify-between mb-3">
                ...
                <p className="font-display font-black text-3xl md:text-4xl text-[#D4AF37] leading-none">
                  {seatsPercent}<span className="text-lg">%</span>
                </p>
              </div>
