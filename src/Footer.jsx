          ...
          <div className="col-span-1">
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              >
                ...
                >
                  <path
                    d="M22 12a10 10 0 10-11.5 9.9v-7H8v-3h2.5V9.2c0-2.5 1.5-3.9 3.7-3.9 1.1 0 2.2.2 2.2.2v2.4h-1.2c-1.2 0-1.6.8-1.6 1.6V12H20l-.5 3h-2.3v7A10 10 0 0022 12z"
                    fill="#F7F4EF"
                  />
                </svg>
              </a>
              ...
              >
                ...
                >
                  <path
                    d="M22 8s-.2-1.4-.8-2c-.8-.9-1.7-.9-2.1-1C15.6 4 12 4 12 4h0s-3.6 0-6.9.9c-.4.1-1.3.1-2.1 1C2.2 6.6 2 8 2 8s-.2 1.7-.2 3.4v1.2C1.8 15 2 16.4 2 16.4s.2 1.4.8 2c.8.9 1.9.8 2.4.9C8.4 20 12 20 12 20s3.6 0 6.9-.9c.4-.1 1.3-.1 2.1-1 .6-.6.8-2 .8-2s.2-1.7.2-3.4v-1.2C22.2 9.7 22 8 22 8z"
                    stroke="#F7F4EF"
                    strokeWidth="0.3"
                  />
          ...
          <div className="col-span-1">
            ...
            <div className="mt-4 text-sm text-[#F7F4EF]/90 space-y-2">
              <div className="flex items-center gap-2">
                ...
                >
                  <path
                    d="M21 10v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-7"
                    stroke="#F7F4EF"
                    strokeWidth="1.2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  <path
                    d="M22 16.92V21a1 1 0 0 1-1.11 1 19.86 19.86 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.86 19.86 0 0 1-3.07-8.63A1 1 0 0 1 3 2h4.09a1 1 0 0 1 1 .75c.12.55.33 1.36.6 2.27a1 1 0 0 1-.24 1l-1.2 1.2a15 15 0 0 0 6 6l1.2-1.2a1 1 0 0 1 1-.24c.9.27 1.72.49 2.27.6a1 1 0 0 1 .75 1V22z"
                    stroke="#F7F4EF"
                    strokeWidth="0.9"
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <div className="mt-3">
                <h5 className="text-xs uppercase tracking-wider text-[#D4AF37]">
                  Subscribe
                </h5>
                <form
                ...
                >
                  ...
                  <input
                    ...
                    required
                    className="px-3 py-2 rounded-md bg-white/5 text-sm w-full focus:outline-none focus:ring-2 focus:ring-[#D4AF37]"
                  />
                  <button
                    type="submit"
                    className="inline-flex items-center bg-[#D4AF37] text-[#072031] px-3 py-2 rounded-md text-sm font-semibold hover:bg-yellow-400 transition-colors"
                  >
                    Subscribe
                  </button>
                </form>
      ...
      <div className="bg-[#031826] border-t border-[#0b3a57]/40">
        <div className="max-w-7xl mx-auto px-6 sm:px-10 py-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/privacy"
              className="text-[#F7F4EF]/60 hover:text-[#D4AF37] transition-colors"
            >
              Privacy
            </Link>
            <Link
